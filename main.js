// 🟢 main.js
// Arnold Admin — FULL REPLACEMENT (Build 2026-03-10R4-splitPass3Safe)
...
function setSessionPill(isLoggedIn, name) {
  ...
  // renderNotesToggle moved to renderActivity.js
...
function renderSubscriptionRow(s) {
  ...
  // renderCustomerActivity moved to renderActivity.js
...
async function doSearch() {
  ...
  // Render smoke test guard
  if (typeof renderCustomerActivity !== "function") {
    console.error("Arnold Admin: renderCustomerActivity is missing. Activity renderer not loaded.");
  }
